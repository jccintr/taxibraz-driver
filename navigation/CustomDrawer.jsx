...
const talk = () => {
  const mensagem = `Olá, sou o ${loggedUser.name}, motorista do Taxi Braz.`;
  ...
  return (
    ...
    <DrawerContentScrollView>
         ...
         />
          <DrawerItem
            icon={()=><FontAwesome6 name="pix" size={22} color="black" />}
            label="Meu Pix"
         ...
         />
          <DrawerItem
            icon={()=><MaterialIcons name="attach-money" size={20} color="black" />}
            label="Meus Ganhos"
